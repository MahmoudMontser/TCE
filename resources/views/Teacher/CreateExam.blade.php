...
<section id="home">
    <div class="container pt-3">
        <!--  عنوان الصفحه -->
        <h4 class="h-header mx-auto pt-5">اضافة اختبار </h4>
        ...
        <div class="row pt-4 pb-2">
            ...
            <!--  بداية الفورم -->
            <form action="{{URL::to('teacher/create/exam/'.$department->id)}}" method="post" enctype="multipart/form-data" class="col-9 col-md-7 mx-auto pb-5">
                {{csrf_field()}}
                ...
                <div class="input-group pt-3">
                    ...
                    <input type="date"   class="form-control text-center @if($errors->has('exam_date'))  is-invalid @endif" name="exam_date" id="exam-date">
                ...
                <div class="input-group pt-3">
                    ...
                    <input type="time" class="form-control text-center"  class="form-control text-center @if($errors->has('start_time'))  is-invalid @endif" name="start_time" id="start-time">
                ...
                <div class="input-group pt-3">
                    ...
                    <input type="time" class="form-control text-center"  class="form-control text-center @if($errors->has('end_time'))  is-invalid @endif" name="end_time" id="end-time">
