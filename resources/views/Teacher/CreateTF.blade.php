...
<section id="home">
    <div class="container pt-3">
        ...
        <div class="row">
            <form action="{{URL::to('teacher/exam/'.$exam->id.'/create/question/TF')}}" method="post" enctype="application/x-www-form-urlencoded" class="col-12 col-md-7 mx-auto pb-5 row">
       {{csrf_field()}}
