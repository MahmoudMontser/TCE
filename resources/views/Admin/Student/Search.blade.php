...
<section id="depart-page">
    <div class="container pt-5">
        <div class="row p-t-100">
            <form action="{{URL::to('/admin/student/search')}}" method="post" enctype="multipart/form-data" class="col-9 col-md-6 mx-auto pb-5">
                {{csrf_field()}}
                <div class="input-group pt-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text c-bg-f color-white fz-14 @if($errors->has('job_id')) text-danger @endif " id="id-trainee-pre">الرقم الاكاديمي</span>
                    </div>
