...
<section id="add-new">
    ...
    <div class="container">
        <h4 class="h-header mx-auto pt-5">تسجيل بيانات مدرب جديد </h4>
        <div class="row">
            <form action="{{URL::to('/admin/teachers')}}" method="post" enctype="multipart/form-data" class="col-9 col-md-6 mx-auto pb-5">
                    {{csrf_field()}}
