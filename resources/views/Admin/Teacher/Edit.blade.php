...
<section id="add-new">
    ...
    <div class="container">
        <h4 class="h-header mx-auto pt-5">تعديل بيانات مدرب  </h4>
        <div class="row">
            <form action="{{URL::to('admin/teacher/'.$teacher->id.'/edit ')}}" method="post" enctype="multipart/form-data" class="col-9 col-md-6 mx-auto pb-5">
                    {{csrf_field()}}
                <div class="input-group pt-3">
                    ...
                    <input type="text"  value="{{$teacher->name}}" class="form-control text-center @if($errors->has('name'))  is-invalid @endif" name="name"  id="inputName"/>
                    @if($errors->has('name'))
                        <div class="col-sm-3">
                ...
                <div class="input-group pt-3">
                    ...
                    <input type="text"  value="{{$teacher->job_id}}" class="form-control text-center @if($errors->has('job_id'))  is-invalid @endif" name="job_id"  id="job_id"/>
                ...
                <div class="input-group pt-3">
                    ...
                    <input type="text"  value="{{$teacher->national_id}}" class="form-control text-center @if($errors->has('national_id'))  is-invalid @endif" name="national_id"  id="national_id"/>
                ...
                <div class="input-group pt-3">
                    ...
                    <input type="tel" value="{{$teacher->phone}}" class="form-control text-center @if($errors->has('phone'))  is-invalid @endif" name="phone" id="inputTel">
                    @if($errors->has('phone'))
                        <div class="col-sm-3">
                            <small id="passwordHelp" class="text-danger">
                                {{$errors->first('phone')}}
                ...
                <div class="input-group pt-3">
                    ...
                    <input type="email"  value="{{$teacher->email}}" class="form-control text-center @if($errors->has('email'))  is-invalid @endif" name="email" id="inputEmail">
                    @if($errors->has('email'))
                        <div class="col-sm-3">
                            <small id="passwordHelp" class="text-danger">
                                {{$errors->first('email')}}
                ...
                <div class="input-group pt-3">
                    ...
                    <input type="text"  value="{{$teacher->user_name}}" class="form-control text-center @if($errors->has('user_name'))  is-invalid @endif" name="user_name"  id="user_name"/>
