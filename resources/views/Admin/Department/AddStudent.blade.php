...
<form id="AddStudent" action="{{URL::to('/admin/departments/add/student')}}" method="post" enctype="multipart/form-data" class="col-9 col-md-7 mx-auto pb-2">
...
<section id="depart-page">
    <div class="container pt-3">
        <h4 class="h-header mx-auto pt-5">اضافة متدرب لشعبه </h4>
        <div class="row">
            <form id="student_form" action="{{URL::to('/admin/departments/add/student/search/student')}}" method="post" enctype="multipart/form-data" class="col-9 col-md-7 mx-auto pb-5">
                    {{csrf_field()}}
                <div class="row">
        ...
        <!-- الشعبه -->
        <div class="row pt-4">
            <form  id="department_form" action="{{URL::to('/admin/departments/add/student/search/department')}}" method="post" enctype="multipart/form-data" class="col-9 col-md-7 mx-auto pb-5">
                {{csrf_field()}}
                <div class="row">
        ...
        <div class="row">
            <div class="input-group pt-3 d-flex justify-content-center">
                <button type="button"  id="submit_add" onclick="submit_add()" class="btn color-white c-bg-f">اضافه</button>
