...
<section id="depart-page">
    <div class="container pt-4">
        <h4 class="h-header mx-auto pt-5">اسناد شعبه لمدرب </h4>
        <div class="row">
            <form action="{{URL::to('/admin/departments/add/teacher')}}" method="post" enctype="multipart/form-data" class="col-9 col-md-6 mx-auto pb-5">
                {{csrf_field()}}
